...
<p align="center">
  ...
  A modern, self-hosted Termius alternative for Linux, macOS, and Windows · <strong>v0.1.5</strong>
</p>

<p align="center">
  <a href="https://github.com/itsmefdil/termimus-ssh/releases"><img src="https://img.shields.io/badge/release-v0.1.5-00d2b4.svg?style=flat&label=version" alt="Version v0.1.5" /></a>
...
|---|---|---|
| Desktop Client (Tauri + Rust + React) | `v0.1.5` | [Releases](https://github.com/itsmefdil/termimus-ssh/releases) |
